...
function serverCommandPolicy(command: AgentExecutionCommand, context: InferCommandContext): AgentExecutionCommand {
  ...
  const defaults: Record<AgentExecutionCommandType, ServerPolicy> = {
    ...
    'sales.quote.create': { targetSystem: 'sales', riskLevel: 'medium', budgetAuthority: 'none' },
    'sales.quote.send': { targetSystem: 'sales', riskLevel: 'high', budgetAuthority: 'none' },
    ...
    'finance.invoice.issue': { targetSystem: 'finance', riskLevel: 'medium', budgetAuthority: 'none' },
    'finance.invoice.send': { targetSystem: 'finance', riskLevel: 'high', budgetAuthority: 'none' },
    ...
    'email.send_draft': { targetSystem: 'communication', riskLevel: 'high', budgetAuthority: 'none' },
    ...
    'commerce.product.create': { targetSystem: 'ecommerce', riskLevel: 'medium', budgetAuthority: 'none' },
    'commerce.product.update': { targetSystem: 'ecommerce', riskLevel: 'medium', budgetAuthority: 'none' },
    'commerce.category.create': { targetSystem: 'ecommerce', riskLevel: 'medium', budgetAuthority: 'none' },
    'commerce.category.update': { targetSystem: 'ecommerce', riskLevel: 'medium', budgetAuthority: 'none' },
...
function inferCommand(context: InferCommandContext): AgentExecutionCommand {
  ...
  if (context.targetSystem === 'crm' && context.companyId) {
    return {
      ...
      idempotencyKey: buildIdempotencyKey(['crm.company.enrich', context.companyId]),
    };
  }
  ...
  if (context.targetSystem === 'ecommerce' && context.sourceText && !context.fulfillmentAction) {
    return {
