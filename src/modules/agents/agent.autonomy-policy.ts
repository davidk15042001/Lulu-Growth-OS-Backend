...
const classes: Readonly<Record<string,AutonomyClass>> = {
  ...
  'record.create_artifact':'AUTONOMOUS', 'crm.company.enrich':'AUTONOMOUS', 'crm.company.sync':'AUTONOMOUS', 'crm.create_followup_task':'AUTONOMOUS', 'crm.transition_pipeline':'AUTONOMOUS',
