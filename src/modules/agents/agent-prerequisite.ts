...
const prerequisiteCodes = new Set([
  ...
  'OMNICHANNEL_DELIVERY_PREVIOUSLY_FAILED',
  'OMNICHANNEL_PROVIDER_UNSUPPORTED',
  'UNIFYPORT_CHANNEL_UNSUPPORTED',
  'UNIFYPORT_MESSAGE_ID_MISSING',
  'UNIFYPORT_RECIPIENT_INVALID',
  ...
  'TWILIO_WORKSPACE_TEMPLATE_REQUIRED',
  'TWILIO_WHATSAPP_TEMPLATE_REQUIRED',
