...
const systemAgentDefinitions: readonly AgentDefinition[] = Object.freeze([
  ...
  systemAgent('system:ads-compliance-auditor', 'Ads Compliance & Policy Auditor', 'auditor', 'ads', 'ads compliance', 'Review every paid campaign against platform policy, country requirements and industry restrictions before publication.', ['country_policy_review', 'industry_policy_review', 'claim_review', 'platform_policy_review', 'correction_planning'], ['blocked_policy_violations', 'review_completeness', 'safe_publication_rate'], { confidenceRequirement: 'high', permissions: ['read_audit_context', 'block_unsafe_execution'] }),
