...
Build a clear, conversion-focused information architecture with a homepage, the most relevant product or service overview and detail pages, industry or use-case pages when supported by the customer data, an about or credibility page, a contact or inquiry page, and legal or policy placeholders only when required and clearly marked for customer confirmation. Do not create irrelevant routes merely to fill a quota. Use the analyzed positioning, target audiences, differentiators, recommended content themes, SEO/GEO/AEO findings and customer journey to decide the page order, calls to action and content hierarchy.
...
Every page must have a unique SEO title, meta description, useful slug, clear purpose and factual content. Include global SEO, GEO and AEO foundations when supported by the analysis, but never keyword-stuff. Use only verified company names, brands, products, services, locations, contacts, markets, certifications, standards, prices, metrics, testimonials and legal claims. Never copy example companies, contacts, addresses, product catalogs, color palettes or claims from a reference brief into another customer's website. If information is missing, omit it or use neutral copy that clearly requires confirmation; never present assumptions as facts. Do not claim that the website is connected, published, approved, certified or live. Return a practical provider-compatible plan with up to 8 of the most valuable pages and concise asset briefs for imagery or graphics.`;
