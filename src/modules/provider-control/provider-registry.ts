...
export const PROVIDER_CATALOG: readonly ProviderCatalogEntry[] = [
  ...
  { providerKey: 'google_tag_manager', displayName: 'Google Tag Manager', category: 'MEASUREMENT', implementationStatus: 'NOT_IMPLEMENTED', defaultMode: 'LULU_MANAGED', capabilities: [{ capabilityKey: 'google_tag_manager.containers.read', displayName: 'Read tag containers', requiredScopes: [], defaultStatus: 'UNCONFIRMED' }, { capabilityKey: 'google_tag_manager.containers.publish', displayName: 'Publish reviewed tag container versions', requiredScopes: [], defaultStatus: 'PROVIDER_REVIEW' }] },
  { providerKey: 'google_search_console', displayName: 'Google Search Console', category: 'SEO', implementationStatus: 'NOT_IMPLEMENTED', defaultMode: 'CUSTOMER_OWNED', capabilities: [{ capabilityKey: 'google_search_console.performance.read', displayName: 'Read search performance', requiredScopes: [], defaultStatus: 'UNCONFIRMED' }, { capabilityKey: 'google_search_console.sitemaps.manage', displayName: 'Manage sitemaps', requiredScopes: [], defaultStatus: 'PROVIDER_REVIEW' }] },
  { providerKey: 'google_pagespeed', displayName: 'Google PageSpeed Insights', category: 'SEO', implementationStatus: 'NOT_IMPLEMENTED', defaultMode: 'LULU_MANAGED', capabilities: [{ capabilityKey: 'google_pagespeed.run', displayName: 'Run PageSpeed analysis', requiredScopes: [], defaultStatus: 'UNCONFIRMED' }] },
