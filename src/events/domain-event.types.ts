export const DOMAIN_EVENT_TYPES = {
  ...
  AD_COMPLIANCE_PASSED: 'advertising.compliance.passed',
  AD_COMPLIANCE_BLOCKED: 'advertising.compliance.blocked',
  AD_COMPLIANCE_REVIEW_REQUIRED: 'advertising.compliance.review_required',
  ONBOARDING_CLEANUP_REQUESTED: 'onboarding.cleanup.requested',
  CATALOG_IMPORT_REQUESTED: 'catalog.import.requested',
  CATALOG_IMPORT_REVIEW_REQUIRED: 'catalog.import.review_required',
