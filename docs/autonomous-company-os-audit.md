...
| Meta/TikTok/LinkedIn Ads | PARTIAL | Integration and analytics pages | Meta now has a real read-only Marketing API account/campaign probe in the Provider Control Plane; TikTok/LinkedIn remain catalog-only | Provider discovery/sync for Meta | Advertising capabilities | Meta mutations remain disabled until prepaid payer, budget authorization and observed-cost settlement are verified; TikTok/LinkedIn require provider adapters |
