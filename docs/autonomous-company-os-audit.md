...
| Registered execution commands | PARTIAL | Workspace action outcomes | Server-owned allowlist, risk and budget policy; concrete command materialization | Command packet lifecycle | Canonical service permissions | CRM/Sales pipeline transitions, autonomous quote creation/delivery, guarded invoice issue/delivery, and native calendar event creation execute through canonical services; command vocabulary still does not cover every generated Workspace page |
