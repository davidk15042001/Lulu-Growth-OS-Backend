...
| Meta/TikTok/LinkedIn Ads | PARTIAL | Integration and analytics pages | Meta and LinkedIn now have real read-only account/reporting probes in the Provider Control Plane; TikTok remains catalog-only | Provider discovery/sync for Meta and LinkedIn | Advertising capabilities | Meta/LinkedIn mutations remain disabled until prepaid payer, budget authorization and observed-cost settlement are verified; TikTok still requires a provider adapter |
