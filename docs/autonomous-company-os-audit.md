...
| Autonomous scheduler | EXISTS | Observed status only | Automatic cycles with dedupe and funded-workspace checks | Durable scheduled events | Entitlement + AI funds | Horizontal cadence is fixed; future per-tenant schedules should be configurable |
