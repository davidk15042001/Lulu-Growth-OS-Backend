...
| Registered execution commands | PARTIAL | Workspace action outcomes | Server-owned allowlist, risk and budget policy; concrete command materialization | Command packet lifecycle | Canonical service permissions | Command vocabulary does not yet cover every generated Workspace page |
...
| Sales leads/opportunities/tasks | PARTIAL | Consolidated Workspace routes | Generic records; canonical quotes are separate | Reactive record handling and follow-up commands | Leads/opportunities/quotes capabilities | Canonical lead/deal state machines and provider CRM sync are still missing |
